...
description = "pdb-search: A tool for analyzing membrane proteins"
# Long description will go up on the pypi page
long_description = """

pdb-search
========
pdb-search is a tool for analyzing membrane proteins from the
...
To find ou more about the project, please go to the repository README_:

.. _README: https://github.com/UWSEDS-aut17/pdb-search/blob/master/README.md

License
=======
``pdb-search`` is licensed under the terms of the MIT license. See the file
...
URL = "https://github.com/UWSEDS-aut17/pdb-search"
DOWNLOAD_URL = ""
LICENSE = "MIT"
...
VERSION = __version__
PACKAGE_DATA = {'pdb-search': [pjoin('data', '*')]}
REQUIRES = ["numpy", 
            "scipy", 
            "matplotlib", 
            "pandas", 
